...
<div class="container mtb">
    ...
    <form role="form" action="<?php echo base_url().'dev/updateProfile';?> " method='post' enctype="multipart/form-data" >
        <div class="col-md-6">
            <h4>Your Profile.</h4>
            <div class="hline"></div>
            ...
            ?>
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" value="<?php foreach ($dataArray as $data) echo $data['pic'];?>" name="old_pic">
                    ...
                    <div class="recentitems portfolio">
                        <div class="portfolio-item graphic-design">
                            <div class="he-wrap tpl6">
                                <img src="<?php echo base_url();?>uploads/<?php foreach($dataArray as $data) echo $data['pic'];?>" alt="">
