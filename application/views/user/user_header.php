    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse navbar-right">
            <ul class="nav navbar-nav">
                ...
                <li class="active  "><form class="navbar-form navbar-left "method="post" action="<?php echo base_url('User/search');?>">
                        <div class="form-group ">
                ...
                if($this->session->userdata('dev_id')||($this->session->userdata('user_id')))
                {
                    ...
                    echo "<li><a href=".site_url()."Dev/dashboard".">PROFILE</a></li>";
                }
                else
                {
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<?php echo site_url().'User/selectedApps/1'; ?>">WINDOWS APPS</a></li>
                        <li><a href="<?php echo site_url().'User/selectedApps/2'; ?>">ANDROID APPS</a></li>
